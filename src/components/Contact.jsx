    ...
    <>
      <div className="container px-5 md:px-16 lg:px-20 mx-auto py-10 mt-12">
        <div className="text-center border-b border-gray-200 dark:border-gray-700 py-5 mb-10">
          <h2 className="text-lg md:text-2xl font-semibold inline-block text-red-600 pb-2">Contact Us</h2>
        ...
        <div className="lg:grid lg:grid-cols-3 gap-10 ">
          ...
          <button
            type="submit"
            className="text-white bg-red-600 hover:bg-red-700 focus:ring-4 focus:ring-red-300 focus:outline-none font-medium rounded-lg text-lg w-full sm:w-auto px-10 py-3 text-center"
          >
            Send
          </button>
        </form>
        ...
        <div className="border border-gray-200 dark:border-gray-700 shadow-md rounded-lg p-10 h-fit">
          <p className="text-red-600 text-lg">GET IN TOUCH</p>
